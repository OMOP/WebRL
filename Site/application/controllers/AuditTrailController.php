...
/*================================================================================
    ...
    Controller for audit trail pages
...
================================================================================*/
class AuditTrailController extends Zend_Controller_Action
{
    ...
    public function listAction()
    {
        ...
        $mapper = new Application_Model_SecurityLogMapper(
            array(
                Application_Model_SecurityLogMapper::
                    ISSUE_TYPE_PASSWORD_CHANGED,
                Application_Model_SecurityLogMapper::
                    ISSUE_TYPE_USER_INFORMATION_CHANGED,
                Application_Model_SecurityLogMapper::
                    ISSUE_TYPE_USER_CREATED,
                Application_Model_SecurityLogMapper::
                    ISSUE_TYPE_SITE_CONFIGURATION_CHANGED
            )
        );
        ...
        if (isset($pagerConf->per_page_audittrail_list))
            $paginator->setItemCountPerPage($pagerConf->per_page_audittrail_list);
