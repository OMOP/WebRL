...
================================================================================*/
class Application_Model_AnalysisUploadLog extends Application_Model_Abstract
{
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper('Application_Model_AnalysisUploadLogMapper');
        }
        return $this->_mapper;
    }
    ...
    public function setUploadDate($date = null)
    {
        if ($date === null)
            $date = gmdate('c');
