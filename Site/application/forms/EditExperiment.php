...
================================================================================*/
class Application_Form_EditExperiment extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $this->addElement('text', 'directoryPattern', array(
            ...
            'validators' => array(
                array('StringLength', false, array(0, 50)),
                $mapper->getUniquePatternValidator($this->getId())
            )
        ));
        
        $this->addElement('text', 'sourceDrugEra', array(
            'label' => 'Source Drug Era',
            'class' => 'text',
            'required' => true,
            'maxlength' => 30,
            'validators' => array(
        ...
        $this->addElement('text', 'sourceConditionEra', array(
            'label' => 'Source Condition Era',
            'required' => true,
            'class' => 'text',
            'maxlength' => 30,
            'validators' => array(
