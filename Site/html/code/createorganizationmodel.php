...
/*================================================================================
    ...
    Page model for /create_organization page. Manage all user data within /create_organization page.
...
class CreateOrganizationModel extends PageModel
{
	var $organizations;
	var $soft_types;
	var $db_types;
    ...
    {
        return SiteConfig::get()->default_money_limit;
    }
}
