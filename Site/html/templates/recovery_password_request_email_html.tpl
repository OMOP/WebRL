...
We have received your request to reset your Research Lab password. Please <a href="{$site}/index.php?page=reset&action={$user->user_id}_{$unique_key}">use this URL</a> to reset your password within 7 days.
