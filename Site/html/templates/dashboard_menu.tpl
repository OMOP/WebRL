...
Running Instances
{else}
<a href="{php}echo PageRouter::build('instances'){/php}" title="Running Instances">Running Instances</a>
{/if}
{if $current_user->organization_id == 0} |
{if $page=='running_methods'}
Running Methods
{else}
<a href="{php}echo PageRouter::build('running_methods'){/php}" title="Running Methods">Running Methods</a>
{/if}
{/if}
